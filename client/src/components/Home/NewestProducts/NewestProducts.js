...
//                 const data = await response.json();
//                 if (Array.isArray(data)) {
//                     // Фильтрация товаров, чтобы исключить товары с isActive === false
//                     const filteredProducts = data.filter(product => product.isActive !== false);
//                     setNewestProducts(filteredProducts);
//                 } else {
//                     throw new Error('Unexpected response format');
//                 }
//             } catch (error) {
