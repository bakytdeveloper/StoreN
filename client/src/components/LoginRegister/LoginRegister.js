    ...
    const handleSendOtpForgotPassword = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setForgotPasswordResendTimer(60); // Set timer for 60 seconds
                setOtpErrorForgotPassword(''); // Clear OTP error message on successful OTP send
    ...
    return (
        <form className="form">
            ...
            <div className="text-login-or-register-block">
                ...
                >
                    {isRegisterMode ? 'У вас уже есть аккаунт? Войти' : 'Еще нет аккаунта? Зарегистрируйтесь'}
                </p>
            </div>
        </form>
    );
