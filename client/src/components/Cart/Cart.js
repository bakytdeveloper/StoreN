...
//     };
//
//     // Обновите функцию handleContinue, чтобы она сохраняла имя пользователя или гостя
//     const handleContinue = () => {
//         if (section === 1) {
//             setSection1Filled(true);
//             setSection(2);
...
//                 setSection2Filled(true);
//                 setUserName(firstName); // Сохраняем имя пользователя или гостя
//                 setSection(3);
//             } else {
...
//     };
//
// // Обновите функцию handlePlaceOrder, чтобы она использовала имя пользователя или гостя при создании заказа
//     const handlePlaceOrder = async () => {
//         try {
...
//                     paymentMethod,
//                     comments,
//                     userName: userName || 'Гость', // Используем имя пользователя или 'Гость'
//                 }),
//             });
//             if (response.ok) {
//                 const data = await response.json();
