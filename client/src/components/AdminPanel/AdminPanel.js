...
//             try {
//                 const response = await fetch('http://localhost:5505/api/products');
...
//         try {
//             const response = await fetch(`http://localhost:5505/api/admin/products/${productId}`, {
//                 method: 'DELETE',
//                 headers: {
...
//
//             if (selectedProduct) {
//                 response = await fetch(`http://localhost:5505/api/admin/products/${selectedProduct._id}`, {
//                     method: 'PUT',
//                     headers: {
//                         'Content-Type': 'application/json',
//                     },
...
//                 });
//             } else {
//                 response = await fetch('http://localhost:5505/api/admin/products', {
//                     method: 'POST',
//                     headers: {
//                         'Content-Type': 'application/json',
//                     },
